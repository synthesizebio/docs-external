...
<CardGroup cols={3}>
  <Card
    title="GEM-1 bulk"
    icon="chart-column"
    href="https://www.biorxiv.org/content/10.1101/2025.09.08.674753v1"
  >
    Baseline model for predicting **bulk** gene expression.
  </Card>
  <Card
    title="GEM-1 single-cell"
    icon="microscope"
    href="https://www.biorxiv.org/content/10.1101/2025.09.08.674753v1"
  >
  ...
  <Card title="GEM-2" icon="sparkles">
    <Tooltip tip="GEM-2 is coming soon.">**Coming soon**</Tooltip> — next-generation
    capabilities.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="link"
    href="https://synthesizebio.substack.com/p/understanding-gem-1s-adaptability"
  >
