...
2. **`conditioning`** — Which latent spaces to condition on (typically `c("biological", "technical")`)
...
Controls which latent spaces are conditioned on the reference. Default is `c("biological", "technical")`.
