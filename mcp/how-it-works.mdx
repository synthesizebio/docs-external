...
1. **Synthia** — interprets the natural-language prompt and extracts the sample metadata needed to run the comparison.
...
Continue to [Usage Examples](/mcp/usage-examples) for prompt patterns that work well.
